...
*/
    ...
    */
    ...
    let calculadora = (operador) => {
        if (isOperatorValid(operador) === false) {
            return isOperatorValid(operador)
        }

        return function callbackCalc(numero1, numero2) {
    ...
    */
    ...
    let operationInvalid = 'I am not an operator!'
    let invalid = calculadora(operationInvalid);
    if (invalid) {
        number1 = 10;
        number2 = 20;
        console.log(showOperationMessage(operationInvalid, number1, number2), sum(number1, number2));
    }
    else {
        console.log(showErrorMessage(operationInvalid))
    }
